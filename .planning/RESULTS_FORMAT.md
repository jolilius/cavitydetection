...
| `explanation` | string (optional) | LLM-generated description of optimization strategy (Phase 2+). Only present when explanations are captured during iteration. Absent in Phase 1 results. |
...
6. **Explanation field presence:** Explanation field is optional; missing explanations do not invalidate results
...
**Phase 2: Introduces optional explanation field; backward compatible (Phase 1 results still valid, just without explanation)**
